...
abstract class AppColors {
  ...
  static const Color searchBoxColor = Color(0xFFF9F9F9);
  static const Color statusBarColor = Color(0xFF4F7096);
  static const Color appBarColor = Color(0xFF4F7096);
  ...
  static const Color centerTextColor40 = Color(0x66242424);
  static const MaterialColor colorPrimarySwatch = Colors.cyan;
  // static const Color colorPrimary = Color(0xFFA35F5D);
  static const Color colorPrimary = Color(0xFF000000);
  static const Color colorSecondary = Color(0xFF4F7096);
  static const Color colorPrimary60 = Color(0x99A35F5D);
  static const Color colorPrimary40 = Color(0xFFFBEFF1);
  static const Color colorPrimary10 = Color(0xFF535763);
  static const Color colorPrimary30 = Color(0xD7F1D4D3);
  static const Color colorAccent = Color(0xFFA35F5D);
  ...
  static const Color unSelectedColor = Color(0xFF545454);
  static const Color unSelectedColor20 = Color(0xFF535763);
  static const Color unSelectedColor40= Color(0xFF555763);
  static const Color borderColor= Color(0xFFE0E0E0);
  static const Color ashColor= Color(0xFFB7B7B7);
  static const Color black15= Color(0x24000000);
  ...
  static const Color stickerColor = Color(0xFFFFC100);
  ...
  static const Color black10 = Color(0xFFB8B8B8);
  static const Color blackBorder = Color(0xFFf4f5f6);
